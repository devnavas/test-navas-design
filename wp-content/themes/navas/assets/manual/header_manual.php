	    ...
	    <div class="uk-container">
	      <div data-uk-navbar>
	        <div class="uk-navbar-left">
			    <a class="uk-navbar-item uk-logo uk-visible@m" href="<?php echo site_url(); ?>/manual"><img src="<?php echo get_template_directory_uri(); ?>/assets/manual/src/img/navas.svg" style="height: 15px!important;"></a>	          
	            <ul class="uk-navbar-nav uk-visible@m">	                
				    <li ><a href="<?php echo site_url(); ?>/wp-admin">Painel de Gestão</a></li>
	            </ul>
	        </div>
	        <div class="uk-navbar-center uk-hidden@m">
	          <a class="uk-navbar-item uk-logo" href="<?php echo site_url(); ?>/manual"><img src="<?php echo get_template_directory_uri(); ?>/manual/src/img/navas.svg" style="height: 15px!important;"></a>
	        </div>
